...
// Cross Module References
	...
	ARCONAID2_API UClass* Z_Construct_UClass_ABall();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABall_GetBall_Statics::Function_MetaDataParams[] = {
		{ "Comment", "// le damos la direcion de ustatimesh a getball;\n" },
		{ "ModuleRelativePath", "Ball.h" },
		{ "ToolTip", "le damos la direcion de ustatimesh a getball;" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABall_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABall_GetBall, "GetBall" }, // 1028551783
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ABall, 300751634);
	template<> ARCONAID2_API UClass* StaticClass<ABall>()
	{
		return ABall::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABall(Z_Construct_UClass_ABall, &ABall::StaticClass, TEXT("/Script/ARCONAID2"), TEXT("ABall"), false, nullptr, nullptr, nullptr);
